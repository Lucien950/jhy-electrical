...
export type DeepPartial<T> = T extends Primatives ? T | undefined
  ...
  : T extends Array<infer ArrayType> ? Array<ArrayType extends Primatives ? ArrayType : DeepPartial<ArrayType>>
