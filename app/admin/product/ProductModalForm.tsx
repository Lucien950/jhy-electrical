		...
		<div className="bg-neutral-300 rounded-md py-2 px-4" key={defaultVariant.sku}>
			<div className="flex flex-row">
				{defaultVariant.images?.map((img) => 
					<ImageDragArea defaultImageURL={img || null} addVariantImageFile={addVariantImageFile} removeVariantImageFile={removeVariantImageFile} key={`drag-area-preview-${img}`} />
				)}
			</div>
