	...
	return (
		<>
			...
			<div className="container mx-auto">
				...
				<div className="flex flex-col md:flex-row justify-center gap-x-12 gap-y-8 px-4 max-w-7xl mx-auto my-10">
					<div>
				...
				{/* Specialty */}
				<div className="grid grid-cols-1 md:grid-cols-2 md:px-12 gap-x-6 mb-4 md:mb-20">
				...
				{/* CALL TO ACTION */}
				<div className="grid grid-cols-1 md:grid-cols-3 px-4 md:px-16 py-10 md:py-24 gap-y-4 text-white bg-zinc-900">
					<div className="col-span-2">
						<h1 className="text-4xl">Call for a <span className="text-green-500">FREE Estimate</span></h1>
						<h1 className="text-7xl text-blue-400"><a href="tel:6135191650">613-355-2788</a></h1>
					</div>
					<div>
						<h1 className="font-bold mb-1">Email</h1>
						<p><a href="mailto:wei201108@gmail.com">wei201108@gmail.com</a></p>
