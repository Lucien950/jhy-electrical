...
const ShippingForm = (
	{ customerInformation, setCustomerInformation, cart, proceedPayment, canGoToPayment}:
		{ customerInformation: CustomerInterface, setCustomerInformation: Dispatch<SetStateAction<CustomerInterface>>, cart: productInfo[], proceedPayment: FormEventHandler<HTMLFormElement>, canGoToPayment : boolean}) => {
...
type p0Input = {
	...
	cart: productInfo[], paymentInformation: Price,
	nextCheckoutStage: () => void,
	canGoToPayment: boolean
}
const p0 = ({ customerInformation, setCustomerInformation, cart, paymentInformation, nextCheckoutStage, canGoToPayment }: p0Input) => {
	return (
